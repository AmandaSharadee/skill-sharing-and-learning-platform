...
public class LearningProgressModel {
    ...
    public LearningProgressModel(String id, String postOwnerID, String postOwnerName, String title, String description, Date  date, String category, String imageUrl) {
        this.id = id;
